...
<head>
    ...
    <title>Criar Curso de Informática</title>
        ...
        <form action="controller.do" method="post">
            ...
            <div class="row">
             ...
             <div class="row">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                    <label for="login">Descrição do software</label>
                    <input type="text" class="form-control" name="descSoftware" id="descSoftware" required maxlength="60">
                </div>
            </div>
             <div class="row">
                <div class="form-group col-md-6">
                    <label for="senha">Nº Lab</label>
                    <input type="text" class="form-control" name="numeroLab" id="numeroLab" >
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-6">
            ...
            <div id="actions" class="row">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary" name="command" value="CriarCursoInfo">Salvar</button>
