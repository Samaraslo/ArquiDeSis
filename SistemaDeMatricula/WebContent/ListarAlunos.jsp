...
<!DOCTYPE html>
        ...
        <body>
            ...
            <div id="main" class="container-fluid">
                <form action="ListarAlunos.do" method="post">
          					...
          					<c:forEach var="aluno" items="${lista }">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                ...
                                                <button id="btn${aluno.id }%>" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-cliente="${aluno.id }">Excluir</button>
                                            </td>
                                        </tr>
                            </c:forEach>
