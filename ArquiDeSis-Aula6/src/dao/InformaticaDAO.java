...
public class InformaticaDAO{
   ...
   public void Create(InformaticaTO to) throws Exception {
     try{
      ...
      p.setString(5, to.getNumeroVagas());
      p.setString(6, to.getValorCurso());
      p.setString(7, to.getDescricao());
      p.setString(8, to.getNumeroVagas());
      p.setString(9, to.getDisponibilidade());
      //  p.close();
   ...
   public void delet(InformaticaTO to) throws Exception {
      String sql = "delete from tbInformatica where idInfo = ?";
      con = ConnectionFactory.conector(); 
      PreparedStatement p = con.prepareStatement(sql);
      
      p.setString(1, to.getIdCurso());
    ...
    public void update(InformaticaTO to) throws Exception {
      ...
      p.setString(6, to.getNumeroVagas());
      p.setString(7, to.getValorCurso());
      p.setString(8, to.getDescricao());
      p.setString(9, to.getNumeroVagas());
      p.setString(10,to.getIdCurso());
