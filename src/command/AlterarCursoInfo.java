...
public class AlterarCursoInfo implements Command {
...
CursoInfoTO infoTO = new CursoInfoTO();
		...
		info.atualizar();
		ArrayList<CursoInfoTO> lista = (ArrayList<CursoInfoTO>)session.getAttribute("lista");
		int pos = busca(info, lista);
		lista.remove(pos);
		lista.add(pos, info.getTO());
